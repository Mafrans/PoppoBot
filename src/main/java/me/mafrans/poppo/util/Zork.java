/**
 * Engine for running the "adventure" command.
 *
 * @author Drew Schuster, dtschust
 * @since 1.7
 * @version 1.0
 */
...
public class Zork {
    ...
    public Zork(String filename, TextChannel textChannel) {
        int i, j, k, l, x, y, z;
    ...
    public String waitForInput() {
        ...
        String newInput = lastInput;
        lastInput = null;

        System.out.println("[Zork]Input: " + newInput);
        return newInput;
    }
    ...
    public static void close(TextChannel channel) {
        for(Zork zork : registeredInstances) {
            if(zork.channel.getId().equals(channel.getId())) {
                zork.close();
            }
        }
    }
    ...
    public void onInput(String input) {
        System.out.println("Zork Event Received");
        lastInput = input;
    }
    ...
    public void register() {
        ...
        System.out.println(registeredInstances.size());
    }
}
